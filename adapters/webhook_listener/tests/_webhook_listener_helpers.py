"""Test-only helpers for webhook_listener's live-NATS integration tests.
A local copy of the same connect()/wait_until_cache_nonempty() pattern
used in libs/jetcore/tests/_helpers.py and
adapters/file_storage_adapter/tests/_file_storage_helpers.py — not a
cross-package import, for the same self-containment reason those explain
(a bare-name collision across workspace members is a confirmed, repeated
failure mode in this project, Design.md §12 Step C1)."""
